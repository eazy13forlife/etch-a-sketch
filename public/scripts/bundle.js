...
var returnRandomRGB = function returnRandomRGB() {
  ...
  for (var i = 1; i <= 3; i++) {
    if (i !== 3) {
      var newNumber = Math.ceil(Math.random() * 255);
      numbers += newNumber + ", ";
    } else {
      var _newNumber = Math.ceil(Math.random() * 255);
      numbers += _newNumber;
    }
  }
  return numbers;
    ...
    divItem.addEventListener("mouseover", function (e) {
      ...
      if (!this.classList.contains("selected")) {
        ...
        this.addEventListener("click", function (e) {
          _this.setAttribute("style", "background-color:" + color);
...
/***/ 0:
/*!**************************************************************************!*\
  !*** multi core-js/stable regenerator-runtime/runtime ./source/index.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
